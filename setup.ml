...
(* OASIS_START *)
(* DO NOT EDIT (digest: 09cb5166b64cf517217a0d40fcf876ea) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the UNIX cli";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Test_interface"; "Vchan_http"; "ExtentlistSet"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "testvmlib";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mbr-format", None);
                           FindlibPackage ("fat-format", None);
                           FindlibPackage ("fat-format.lwt", None);
                   ...
                   {exec_custom = false; exec_main_is = "lifecycle_test.ml"; 
                   })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\146mi\229\222$\142\222\142k\251\140\234\232K\171";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
